...
::Ice::Int ServerI::TSUNotifyTcpTansferEnd(const ::std::string& strTranferSessionID, ::Ice::Int iType, const ::Ice::Current&)
{
#ifndef WIN32
	return MsgOp::DealTSUNotifyTcpTansferEnd(strTranferSessionID, iType);
#else
	return 0;
#endif
}
...
::Ice::Int ServerI::TSUSendImageResult(::Ice::Int iType, ::Ice::Int iResult, const ::std::string& strDeviceID, ::Ice::Int iChannelID, const ::std::string& strGuid, ::Ice::Int iPicCount, const BYTEBUFFER& strPicContent, const ::Ice::Current&)
{
#ifndef WIN32
	return MsgOp::DealTSUSendImageResult(iType, iResult, strDeviceID, iChannelID, strGuid, iPicCount, strPicContent);
#else
	return 0;
#endif
}
