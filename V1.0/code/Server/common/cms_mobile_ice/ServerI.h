...
#if 1 //手机app
 virtual ::Ice::Int TSCServerRegister(const ::std::string& sTscID, const ::std::string& sTscVideoIP, const ::std::string& iVideoIPEth, const ::std::string& sTscDeviceIP, const ::std::string& iDeviceIPEth, ::Ice::Int iExpires, ::Ice::Int iRefresh,int rtspserverport,const ::Ice::Current& = ::Ice::Current());	
 virtual ::Ice::Int RTSPServerRegister(const ::std::string& sTsuID, const ::std::string& sTsuVideoIP, const ::std::string& sVideoIPEth, const ::std::string& sTsuDeviceIP, const ::std::string& sDeviceIPEth, ::Ice::Int iExpires, ::Ice::Int iRefresh,int rtspserverport, const ::Ice::Current& = ::Ice::Current());	
 virtual ::Ice::Int RTSPNotifyCurrentTask(const ::EV9000MS::RTSPTaskAttributeList&, const ::Ice::Current&);
 virtual ::Ice::Int RTSPNotifyTaskEnd(const ::std::string& sTaskID, const ::Ice::Current&);
 virtual ::Ice::Int TscNotifyTaskEnd(const ::std::string& sTaskID, const ::Ice::Current&);
#endif
