...
void thread_setup(void)
{
    ...
    CRYPTO_set_locking_callback((void(*)(int,int,const char*,int))ecos_locking_callback);
}
...
void ecos_locking_callback(int mode, int type, char *file, int line)
{
    if (mode & CRYPTO_LOCK)
    {
		...
		//printf("----ecos_locking_callback type:%d mode:%d-----\n",type,mode);
    }
    else
    {
