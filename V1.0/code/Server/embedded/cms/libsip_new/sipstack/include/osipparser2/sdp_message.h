...
extern "C" {
    ...
    struct sdp_message
    {
        ...
        char* y_ssrc;                               /**< SSRC header */
        char* f_param;                              /**< F header */
    ...
    /**
     * Set the o username in a SDP packet.
     * @param sdp The element to work on.
     * @param value The token value.
     */
    int sdp_message_o_username_set(sdp_message_t* sdp, char* name);
    /**
    ...
    /**
     * Set the o_sess_id in a SDP packet.
     * @param sdp The element to work on.
     * @param value The token value.
     */
    int sdp_message_o_sess_id_set(sdp_message_t* sdp, char* name);
    /**
    ...
    /**
     * Set the o_sess_version in a SDP packet.
     * @param sdp The element to work on.
     * @param value The token value.
     */
    int sdp_message_o_sess_version_set(sdp_message_t* sdp, char* name);
    /**
     ...
     * @param sdp The element to work on.
     */
    EV9000SIP_API char* sdp_message_s_name_get(sdp_message_t* sdp);
    /**
     * Set the version in a SDP packet.
     * @param sdp The element to work on.
     ...
     * @param value The token value.
     */
    int sdp_message_y_ssrc_set(sdp_message_t* sdp, char* ssrc);
     ...
     * @param value The token value.
     */
    int sdp_message_f_param_set(sdp_message_t* sdp, char* fparam);
    /**
    ...
    /**
     * Get the ssrc of a SDP packet.
     * @param sdp The element to work on.
     */
    char* sdp_message_y_ssrc_get(sdp_message_t* sdp);   

    /**
     * Get the f of a SDP packet.
     * @param sdp The element to work on.
     */
    char* sdp_message_f_param_get(sdp_message_t* sdp);
    /**
     * Set the version in a SDP packet.
     * @param sdp The element to work on.
     * @param value The token value.
...
#define sdp_e_email_get sdp_message_e_email_get
     ...
     */
    EV9000SIP_API char* sdp_message_t_start_time_get(sdp_message_t* sdp, int pos_td);
    /**
     * Get the stop time value ('t' field) of a SDP packet.
     * @param sdp The element to work on.
     * @param pos_td The time description line number.
     */
    EV9000SIP_API char* sdp_message_t_stop_time_get(sdp_message_t* sdp, int pos_td);
    /**
     ...
     */
    EV9000SIP_API char* sdp_message_r_repeat_get(sdp_message_t* sdp, int pos_time_descr, int pos_repeat);
    /**
