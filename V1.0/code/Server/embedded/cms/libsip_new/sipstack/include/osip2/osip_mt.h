...
extern "C" {
    ...
    int osip_mutex_trylock(struct osip_mutex *mut);
    ...
    int osip_debug_mutex_lock(struct osip_mutex* _mut, const char* file, int line, const char* func);
    int osip_debug_mutex_trylock(struct osip_mutex* _mut, const char* file, int line, const char* func);

    int osip_debug_mutex_unlock(struct osip_mutex* _mut, const char* file, int line, const char* func);
