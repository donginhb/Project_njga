...
osip_dialog_update_route_set_as_uas(osip_dialog_t* dialog, osip_message_t* invite)
{
    ...
    {
        OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_WARNING, NULL, (char*)"missing a contact in invite!\n"));
    }
    else
    {
...
osip_dialog_update_route_set_as_uac(osip_dialog_t* dialog, osip_message_t* response)
{
    ...
    {
        OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_WARNING, NULL, (char*)"missing a contact in response!\n"));
    }
    else
    {
...
osip_dialog_update_tag_as_uac(osip_dialog_t* dialog, osip_message_t* response)
{
    ...
    {
        OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_WARNING, NULL, (char*)"This dialog already have a remote tag: it can't be changed!\n"));
    ...
    {
        OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_WARNING, NULL, (char*)"Remote UA is not compliant: missing a tag in response!\n"));
...
osip_dialog_match_as_uac(osip_dialog_t* dlg, osip_message_t* answer)
{
    ...
    OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_WARNING, NULL, (char*)"Using this method is discouraged. See source code explanations!\n"));
    /*
    ...
    {
        OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_WARNING, NULL, (char*)"Remote UA is not compliant: missing a tag in To fields!\n"));
...
osip_dialog_match_as_uas(osip_dialog_t* dlg, osip_message_t* request)
{
    ...
    if (dlg->remote_tag == NULL)          /* tag in response BUT no tag in dialog */
    {
        OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_WARNING, NULL, (char*)"Remote UA is not compliant: missing a tag in To feilds!\n"));
...
__osip_dialog_init(osip_dialog_t** dialog, osip_message_t* invite, osip_message_t* response, osip_from_t* local, osip_to_t* remote, osip_message_t* remote_msg)
{
    ...
    *dialog = NULL;
    ...
    if (i != 0)
    {
        OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_ERROR, NULL, (char*)"Could not establish dialog!\n"));
...

    {
        ...
        {
            (*dialog)->remote_contact_uri = NULL;
            OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_WARNING, NULL, (char*)"Remote UA is not compliant: missing a contact in remote message!\n"));
        }
    }
...
osip_dialog_free(osip_dialog_t* dialog)
{
    ...
    if (NULL != dialog->line_param)
    {
        osip_free(dialog->line_param);
        dialog->line_param = NULL;
    }
