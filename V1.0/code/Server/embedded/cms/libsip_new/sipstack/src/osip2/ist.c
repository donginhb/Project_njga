...
__osip_ist_init(osip_ist_t** ist, osip_t* osip, osip_message_t* invite)
{
    ...
    OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_INFO2, NULL, (char*)"allocating IST context\n"));
...
__osip_ist_free(osip_ist_t* ist)
{
    ...
    OSIP_TRACE(osip_trace(__FILE__, __LINE__, OSIP_INFO2, NULL, (char*)"free ist ressource\n"));
    osip_free(ist);
    ist = NULL;
    return OSIP_SUCCESS;
}
