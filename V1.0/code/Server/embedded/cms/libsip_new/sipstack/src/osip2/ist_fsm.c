...
osip_ist_timeout_g_event(osip_transaction_t* ist, osip_event_t* evt)
{
    ...
    if (i != 0)
    {
        ...
        /*
          ...
          if (utc_time2 - utc_time1 > 0)
          {
              printf("\r\n osip_ist_timeout_g_event time=%d \r\n", utc_time2 - utc_time1);
          }
          */
...
osip_ist_timeout_h_event(osip_transaction_t* ist, osip_event_t* evt)
{
    ...
    /*
     ...
     if (utc_time2 - utc_time1 > 0)
     {
         printf("\r\n osip_ist_timeout_h_event time=%d \r\n", utc_time2 - utc_time1);
     }
     */
...
osip_ist_timeout_i_event(osip_transaction_t* ist, osip_event_t* evt)
{
    ...
    /*
     ...
     if (utc_time2 - utc_time1 > 0)
     {
         printf("\r\n osip_ist_timeout_i_event time=%d \r\n", utc_time2 - utc_time1);
     }
     */
