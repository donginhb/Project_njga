...
osip_nict_timeout_e_event(osip_transaction_t* nict, osip_event_t* evt)
{
    ...
    if (i < 0)
    {
        ...
        /*
          ...
          if (utc_time2 - utc_time1 > 0)
          {
              printf("\r\n osip_nict_timeout_e_event time=%d \r\n", utc_time2 - utc_time1);
          }
          */
...
osip_nict_timeout_f_event(osip_transaction_t* nict, osip_event_t* evt)
{
    ...
    /*
     ...
     if (utc_time2 - utc_time1 > 0)
     {
         printf("\r\n osip_nict_timeout_f_event time=%d \r\n", utc_time2 - utc_time1);
     }
     */
...
osip_nict_timeout_k_event(osip_transaction_t* nict, osip_event_t* evt)
{
    ...
    /*
     ...
     if (utc_time2 - utc_time1 > 0)
     {
         printf("\r\n osip_nict_timeout_k_event time=%d \r\n", utc_time2 - utc_time1);
     }
     */
