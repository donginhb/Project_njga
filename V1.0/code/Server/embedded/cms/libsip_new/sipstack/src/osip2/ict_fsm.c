...
osip_ict_timeout_a_event(osip_transaction_t* ict, osip_event_t* evt)
{
    ...
    if (i < 0)
    {
        ...
        /*
          ...
          if (utc_time2 - utc_time1 > 0)
          {
              printf("\r\n osip_ict_timeout_a_event time=%d \r\n", utc_time2 - utc_time1);
          }
          */
...
osip_ict_timeout_b_event(osip_transaction_t* ict, osip_event_t* evt)
{
    ...
    if (utc_time2 - utc_time1 > 0)
    {
        printf("\r\n osip_ict_timeout_b_event time=%d \r\n", utc_time2 - utc_time1);
    }
    */
...
osip_ict_timeout_d_event(osip_transaction_t* ict, osip_event_t* evt)
{
    ...
    /*
        ...
        if (utc_time2 - utc_time1 > 0)
        {
            printf("\r\n osip_ict_timeout_d_event time=%d \r\n", utc_time2 - utc_time1);
        }
    */
